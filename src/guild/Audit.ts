import type { Guild, GuildAuditLogsEntry, GuildAuditLogsResolvable } from "discord.js";
...
export async function audit(guild: Guild, query: AuditQuery): Promise<GuildAuditLogsEntry | undefined> {
