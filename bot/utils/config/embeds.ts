...
const embeds = {
  success: (text: string, options?: EmbedOptions) =>
    make(colors.success, emojis.embed.success, text, options),
  warning: (text: string, options?: EmbedOptions) =>
    make(colors.warning, emojis.embed.warning, text, options),
  error: (text: string, options?: EmbedOptions) =>
    make(colors.error, emojis.embed.error, text, options),
  loading: (text: string, options?: EmbedOptions) =>
    make(colors.pending, emojis.embed.pending, text, options),
  info: (text: string, options?: EmbedOptions) =>
    make(colors.default, emojis.embed.info, text, options),
