...
export class GuildStats {
  ...
  public get roles(): number {
    return this.guild.roles.cache.size;
  }
  public get channels(): number {
    return this.guild.channels.cache.size;
  }
  ...
  public get emojis(): number {
    return this.guild.emojis.cache.size;
  }
  public get animated(): number {
    return this.guild.emojis.cache.filter((emoji) => emoji.animated).size;
  }
  public get stickers(): number {
    return this.guild.stickers.cache.size;
  }
  public get created(): number {
    return Math.floor(this.guild.createdTimestamp / 1_000);
  }
  public get locale(): string {
    return this.guild.preferredLocale;
  }
  public get verification(): string {
    return GuildVerificationLevel[this.guild.verificationLevel];
  }
  public get afkTimeout(): number {
    return this.guild.afkTimeout;
  }
  public get afkChannel(): string | null {
    return this.guild.afkChannel?.toString() ?? null;
  }
  public get maxMembers(): number {
    return this.guild.maximumMembers ?? 0;
  }
  public get features(): string[] {
    return this.guild.features.map(pretty);
  }
  ...
  public icon(extension: "png" | "jpg" | "webp" = "png"): string | null {
    return this.guild.iconURL({ size: 4096, extension });
  }
  public banner(extension: "png" | "jpg" | "webp" = "png"): string | null {
    return this.guild.bannerURL({ size: 4096, extension });
  }
  public splash(extension: "png" | "jpg" | "webp" = "png"): string | null {
    return this.guild.splashURL({ size: 4096, extension });
  }
  ...
  public emojiList(limit = this.guild.emojis.cache.size): string[] {
    return [...this.guild.emojis.cache.values()].slice(0, limit).map(String);
  }
  public async loadEmojis(): Promise<string[]> {
    await this.guild.emojis.fetch();
    return this.emojiList();
  }
  public stickerList(limit = 50): string[] {
    return [...this.guild.stickers.cache.values()]
      .slice(0, limit)
...
function position(channel: GuildBasedChannel): number {
