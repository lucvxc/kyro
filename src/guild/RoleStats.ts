...
export class RoleStats {
  ...
  public get members(): number {
    return this.role.members.size;
  }
  public get permissions(): number {
    return this.role.permissions.toArray().length;
  }
  ...
  public get created(): number {
    return Math.floor(this.role.createdTimestamp / 1_000);
  }
  public icon(extension: ImageExtension = "png"): string | null {
    return this.role.iconURL({ size: 4096, extension });
  }
