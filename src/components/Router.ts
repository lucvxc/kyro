...
export class Router {
  ...
  public constructor(client: Client, loader: Loader, cooldown = 0) { this.#client = client; this.#loader = loader; this.#cooldown = cooldown * 1_000; }
  public attach(): void { if (!this.#attached) { this.#client.on(Events.InteractionCreate, this.#onInteraction); this.#attached = true; } }
  public detach(): void { if (this.#attached) { this.#client.off(Events.InteractionCreate, this.#onInteraction); this.#attached = false; } }
