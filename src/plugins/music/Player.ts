...
export class Player {
  ...
  public get guildID(): string { return this.raw.guildId; }
  public get channelID(): string { return this.raw.voiceChannelId; }
  public get current(): Track | null { return this.raw.current ? track(this.raw.current) : null; }
  public get queue(): Track[] { return this.raw.queue.all.map(track); }
  public get history(): Track[] { return this.raw.previous.map(track); }
  public get loop(): Loop { return this.raw.loop as Loop; }
